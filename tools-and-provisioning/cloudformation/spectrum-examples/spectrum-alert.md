...
Spectrum Alerts trigger when a metric passes a defined threshold. Triggers can be linked to [Spectrum Actions](tools-and-provisioning/cloudformation/spectrum-examples/spectrum-actions).
