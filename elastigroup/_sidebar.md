...
- [Elastigroup](elastigroup/)
  ...
  - [Features - Azure](elastigroup/features-azure/)
    ...
    - [Stateful Nodes](elastigroup/features-azure/stateful-nodes/)
  ...
  - [Stateful Nodes](managed-instance/)
    - [Getting Started](managed-instance/getting-started/)
      - [Import an Existing Stateful Node](managed-instance/getting-started/join-an-existing-managed-instance)
    ...
    - [Tutorials](managed-instance/tutorials/)
      - [Upgrade an Existing Elastigroup to Stateful Node](managed-instance/tutorials/upgrade-an-existing-elastigroup-to-managed-instance)
  ...
  - [Tutorials - Azure](elastigroup/tutorials-azure/)
    ...
    - [Use Stateful Nodes](elastigroup/tutorials-azure/use-stateful-nodes/)
      - [Manage](elastigroup/tutorials-azure/use-stateful-nodes/manage)
