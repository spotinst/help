...
The following list covers required and recommended discovery steps to perform for a successful Spot PC onboarding.  The items highlighted in **bold** are required before you can complete the onboarding workflow within the Spot PC console.
