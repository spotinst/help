...
The full body attribute list is available on the [Create](https://docs.spot.io/spotinst-api/elastigroup/amazon-web-services/create/) page of the API documentation.
