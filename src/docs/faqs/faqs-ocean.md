...
* Making the [default virtual node group](ocean/features/launch-specifications?id=default-virtual-node-group) gp3 by adding a block device mapping at the cluster level.
  ...
  <details style="background:#f2f2f2; padding:6px; margin:10px 0px 0px 0px">
   <summary markdown="span" style="color:#7632FE; font-weight:600" id="ocutilize">AWS: Why do some on-demand instances in my AWS account use reservations or savings plans with <i>utilizeCommitments: false</i>?</summary>
