...
- [**Get Started with Spot**](connect-your-cloud-provider/)
  - [Connect Your Cloud Account](connect-your-cloud-provider/first-account/)
    ...
    - [Connect Azure](connect-your-cloud-provider/first-account/terraform)
    - [Connect with Terraform](connect-your-cloud-provider/azure-ea-account)
  ...
  - [View Dashboard](connect-your-cloud-provider/dashboard)
    - [Optimized Your Cloud](connect-your-cloud-provider/dashboard/optimize.md)
    - [Analyze Your Costs](connect-your-cloud-provider/dashboard/cost-analysis/)
      - [Save Analysis Reports](connect-your-cloud-provider/dashboard/cost-analysis/save-reports)
