...
Learn how to use [Prometheus to scrape Ocean metrics](ocean/tools-and-integrations/prometheus-for-kubernetes-data-plane-monitoring/scrape-metrics-using-prometheus).
