...
- [Ocean - start here...](ocean/)
  ...
  - [AWS Kubernetes Features](ocean/aws-kubernetes/)
     ...
     - [Labels & Taints](ocean/features/labels-and-taints)
       ...
       - [Instance Types Labels](ocean/features/labels-and-taints?id=instance-types-labels)
     ...
     - [Scaling (Kubernetes)](ocean/features/scaling-kubernetes)
       ...
       - [Accelerated Scale-down](https://docs.spot.io/ocean/features/scaling-kubernetes?id=accelerated-scale-down)
       - [Scaleup according to Available IPs](https://docs.spot.io/ocean/features/scaling-kubernetes?id=scale-up-according-to-available-ips)
       - [Maximum Pods Custom Configuration](ocean/features/scaling-kubernetes?id=maximum-pods-custom-configuration)
       - [Draining Timeout per VNG](https://docs.spot.io/ocean/features/scaling-kubernetes?id=draining-timeout-per-virtual-node-group)
       - [Scaling Constraints View](ocean/tutorials/view-scaling-constraints)
     - [Shutdown Hours](ocean/features/running-hours)
        - [Shutdown Hours Settings](ocean/tutorials/set-running-hours)
     - [Virtual Node Groups](ocean/features/vngs/)
   ...
   - [Azure AKS Features](ocean/azure-aks/)
     ...
     - [Scaling (Kubernetes)](ocean/features/scaling-kubernetes)
       - [Scaling Constraints View](ocean/tutorials/view-scaling-constraints)
       - [Maximum Pods Configuration](https://docs.spot.io/ocean/features/scaling-kubernetes?id=support-for-max-pods-configuration)
       - [Pod Scaling Readiness](https://docs.spot.io/ocean/features/scaling-kubernetes?id=support-for-pod-scaling-readiness)
