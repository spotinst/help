...
- [Ocean](ocean/)
  ...
  - [Getting Started](ocean/getting-started/)
    ...
    - [AKS-Import Cluster to Ocean](ocean/getting-started/aks/)
      - [AKS Import Prerequisites](ocean/getting-started/aks/aks-prerequisites)
    ...
    - [GKE-Create New Cluster](ocean/getting-started/gke)
      - [Create Cluster using Shared VPC](ocean/tutorials/create-cluster-gke-shared-vpc)
