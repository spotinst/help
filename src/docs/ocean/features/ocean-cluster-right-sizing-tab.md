...
*  Do not create any rule matching for Vertical Pod Autoscaler custom resources that already exist for your workloads before using Ocean Automatic Right-Sizing.
