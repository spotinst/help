...
(Optional) To install the [Ocean Prometheus Exporter](https://docs.google.com/document/d/1qM0DRhqgtSifNb9-j8tuRuNtWamL2mspWrB-iiC70sk/edit#), mark the checkbox. Validate that the Configure Prometheus step is complete.
