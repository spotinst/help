...
- In case you wish to run different types of workloads in the same cluster make sure to create [Virtual Node Group](https://docs.spot.io/ocean/features/vngs/)
