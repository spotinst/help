...
*  **OCN-0020: July 18, 2024:** (**<font color="#FC01CC">GKE</font>**) You can now set the Ocean Autoscaler `maxScaleDownPercentage` for Virtual Node Groups via the console.
[Learn More...](https://docs.spot.io/ocean/features/max-scale-down-vng-gke-ui)

*  **OCN-0019: July 18, 2024:** (**<font color="#FC01CC">GKE</font>**) Right-sizing metrics have been added for the Ocean Prometheus exporter. [Learn More...](https://docs.spot.io/ocean/tools-and-integrations/prometheus/scrape)
