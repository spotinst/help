...
You can now configure Ocean to export logs to an Azure Blob and then access the logs with a central monitoring tool.
...
* **OCN-001**: (**EKS**) As of **May 1, 2024**, **Ocean Controller Version 2** for **AWS Kubernetes** is officially released, bringing a host of new features and enhancements to streamline your operations:
