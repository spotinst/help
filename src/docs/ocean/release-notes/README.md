...
*  **OCN-0030: September 08, 2024:** (**<font color="#FC01CC">AWS</font>**) The Ocean Network Cost Banner under Cost Analysis now contains an estimate of the average hourly network usage (GB), which is updated hourly. [Learn more...](https://docs.spot.io/ocean/tutorials/analyze-your-costs?id=ocean-network-cost-banner)
