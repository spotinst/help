...
You can download the SAML metadata file from your IDP. Send it to **\_** to complete the integration.
...
- **User data**
  ...
  Make sure this code <font color="#FC01CC">is in **\_\_** so ##where do they update this?##</font> the container instances can register the cluster. Update the cluster name.
...
2.  On the Review tab, click **JSON** > **Edit Mode**.</font>
