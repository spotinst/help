...
*  `shouldUtilizeRCommitments`: If there are free RIs/SPs within the AWS account, Stateful Node will utilize them before launching spot instances. The initial default value is inherited from the identical attribute at the cluster level.
