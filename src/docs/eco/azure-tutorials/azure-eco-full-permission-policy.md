# Eco Azure Full Permission Policy

The Eco policy is shown below. Replace the assignableScopes in the json with one or more actual subscriptionIDs you need Eco to review (or manage).
