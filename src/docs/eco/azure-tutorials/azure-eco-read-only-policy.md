# Eco Azure Read-Only Policy

The Eco policy is shown below. The Eco policy is shown below. Replace the assignableScopes in the json with one or more actual subscriptionIDs you need Eco to review (or manage).

The policy below is relevant only for customers who have not yet signed a contract for Eco.
