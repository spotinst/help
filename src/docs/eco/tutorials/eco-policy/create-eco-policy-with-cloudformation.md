...
```json
{
  ...
  "Resources": {
    ...
    "SpotFinOpsRole": {
      "Type": "AWS::IAM::Role",
      "Properties": {
        "Description" :"The bucket name of where the HOURLY Cost and Usage Report is located. https://console.aws.amazon.com/billing/home?#/reports If you have any questions, please contact us at: eco@netapp.com",
