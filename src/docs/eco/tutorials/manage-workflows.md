...
You can create a workflow without billing rules to run reports on raw data. The advantage to this choice is that it provides you with the cost and savings data much quicker. See the article titled "[View Workflow Details](eco/tutorials/view-workflow-details)".
