...
You may create a workflow without billing rules so that you may run reports on raw data. The advantage to this choice is it gets you the cost and savings data much quicker. See the article titled "[View Workflow Details](eco/tutorials/view-workflow-details)".
