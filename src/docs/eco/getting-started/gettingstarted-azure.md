...
It is really easy to get started with Eco. All you need to do is [connect your cloud provider](eco/getting-started/connect-azure-account).

Optimize your use of [reserved instances](eco/azure-tutorials/).
