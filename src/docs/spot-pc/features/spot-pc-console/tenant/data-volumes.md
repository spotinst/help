...
1. Like other tenant pages, [Data Volumes](spot-pc/features/spot-pc-console/tenant/data-volumes) can be accessed by clicking the appropriate tab across the top.
