...
export const aliases = (() => {
  const map = {
    ...
    "/account-user-management/user-management/access-policies-2/":
      "/administration/access-policies/?id=access-policies",

    "/account-user-management/user-management/access-policies-actions/":
      "/administration/access-policies/access-policy-actions?id=access-policy-actions",

    "/account-user-management/gcp-policy/":
      "/administration/api/spot-policy-in-gcp?id=spot-policy-in-gcp",

    "/account-user-management/user-management/identity-providers/adfs-saml-authentication/":
      "/administration/identity-providers/adfs-saml-authentication?id=adfs-saml-authentication",

    "/account-user-management/user-management/sso-access-control/organization-level-sso/":
      "/administration/sso-access-control/organization-level-sso?id=organization-level-sso",

    "/account-user-management/customizing-email-notifications/":
      "/administration/users/configure-email-notifications?id=configure-email-notifications",

    "/cloud-analyzer/": "/cloud-analyzer/?id=cloud-analyzer-overview",

    "/cloud-analyzer/policy-2/":
      "/cloud-analyzer/tutorials/cloud-analyzer-policy/create-cloud-analyzer-policy-with-cloudformation?id=create-cloud-analyzer-policy-with-cloudformation",

    "/cloud-analyzer/optimization/":
      "/cloud-analyzer/tutorials/use-optimization-dashboard/?id=use-the-optimization-dashboard",

    "/eco/eco-faq/": "/eco/troubleshooting/eco-faq?id=eco-faq",

    "/eco/strategy-selection/":
      "/eco/tutorials/choose-a-strategy?id=choose-a-strategy",

    "/eco/eco-policy-2/":
      "/eco/tutorials/eco-policy/create-eco-policy-with-cloudformation?id=create-eco-policy-with-cloudformation",

    "/eco/overview-dashboard-2/":
      "/eco/tutorials/view-your-savings?id=view-your-savings",

    "/container-management/amazon-ecs/elastigroup-for-ecs-concepts/autoscaling/":
      "/elastigroup/features/amazon-ecs/automatic-autoscaler-for-ecs?id=automatic-autoscaler-for-ecs",
    ...
    "/elastigroup-for-aws/concepts/compute-concepts/preferred-instance-types/":
      "/elastigroup/features/compute/preferred-instance-types?id=preferred-instance-types",

    "/elastigroup-for-aws/concepts/compute-concepts/termination-policy/":
      "/elastigroup/features/compute/termination-policy?id=termination-policy",

    "/elastigroup-for-aws/concepts/compute-concepts/using-signals-in-elastigroups/":
      "/elastigroup/features/compute/using-signals-in-elastigroups?id=using-signals-in-elastigroups",

    "/elastigroup-for-aws/concepts/general-concepts/elastigroup-console-configuration-alerts/":
      "/elastigroup/features/core-features/elastigroup-console-configuration-alerts?id=example-2-invalid-block-device-mapping",

    "/elastigroup-for-aws/concepts/general-concepts/market-scoring-managing-interruptions/":
      "/elastigroup/features/core-features/market-scoring-managing-interruptions?id=market-scoring-amp-managing-interruptions",

    "/elastigroup-for-aws/concepts/general-concepts/spot-reserved-on-demand/":
      "/elastigroup/features/core-features/spot-reserved-on-demand-instances?id=spot-reserved-amp-on-demand-instances",

    "/elastigroup-for-google-cloud/concepts/general-concepts/gcp-load-balancers-backend-services/":
      "/elastigroup/features/gcp/gcp-load-balancers-backend-services?id=gcp-load-balancers-backend-services",

    "/elastigroup-for-google-cloud/concepts/compute-concepts/scaling-policies-for-gcp-elastigroup/":
      "/elastigroup/features/gcp/scaling-policies-for-gcp-elastigroup?id=scaling-policies-for-gcp-elastigroup",

    "/elastigroup-for-aws/concepts/stateful-concepts/scheduling-stateful-capacity/":
      "/elastigroup/features/stateful-instance/schedule-stateful-capacity?id=schedule-stateful-capacity",

    "/elastigroup-for-aws/concepts/stateful-concepts/introduction/":
      "/elastigroup/features/stateful-instance/stateful-instances?id=stateful-instances",

    "/integration-docs/mlb/install-general/":
      "/elastigroup/tools-integrations/aws-load-balancers-elb-alb?id=aws-load-balancers-elb-amp-alb",
    ...
    "/elastigroup-for-aws/services-integrations/codedeploy/codedeploy-blue-green-deployment/":
      "/elastigroup/tools-integrations/codedeploy/blue-green-deployment?id=codedeploy-blue-green-deployment",

    "/elastigroup-for-aws/services-integrations/elastic-beanstalk/":
      "/elastigroup/tools-integrations/elastic-beanstalk/?id=what-is-elastic-beanstalk",

    "/elastigroup-for-aws/services-integrations/elastic-beanstalk/beanstalk-tutorials/import-a-beanstalk-environment/":
      "/elastigroup/tools-integrations/elastic-beanstalk/import-a-beanstalk-environment?id=tutorial-import-a-beanstalk-environment",

    "/elastigroup-for-aws/services-integrations/elastic-beanstalk/independent/":
      "/elastigroup/tools-integrations/elastic-beanstalk/independent-elastigroup-integration?id=independent-elastigroup-integration",

    "/elastigroup-for-aws/services-integrations/elastic-mapreduce/import-an-emr-cluster/advanced/":
      "/elastigroup/tools-integrations/elastic-mapreduce/advanced-import-use-bootstrap-and-configuration-files?id=advanced-import-use-bootstrap-and-configuration-files",

    "/container-management/kubernetes/kubernetes-tutorials/create-a-kubernetes-bearer-token/":
      "/elastigroup/tools-integrations/kubernetes-with-elastigroup/create-a-kubernetes-bearer-token?id=create-a-kubernetes-bearer-token",

    "/container-management/kubernetes/kubernetes-concepts/pod-driven-autoscaling/":
      "/elastigroup/tools-integrations/kubernetes-with-elastigroup/kubernetes-cluster-autoscaling?id=kubernetes-cluster-autoscaling",

    "/container-management/nomad/nomad-autoscaler-setup/":
      "/elastigroup/tools-integrations/nomad/configure-nomad-autoscaler?id=configure-nomad-autoscaler",

    "/elastigroup-for-aws/services-integrations/route53/":
      "/elastigroup/tools-integrations/route53?id=optional-cross-account-route53-integration",

    "/container-management/amazon-ecs/tutorials/configure-attributes-for-task-placement-constraints/":
      "/elastigroup/tutorials/amazon-ecs/configure-attributes-for-task-placement-constraints?id=configure-attributes-for-task-placement-constraints",

    "/container-management/kubernetes/eks/create-elastigroup-based-eks-cluster/":
      "/elastigroup/tutorials/amazon-eks/create-elastigroup-eks-cluster?id=create-elastigroup-eks-cluster",

    "/elastigroup-for-aws/tutorials/kms-encryption-and-spotinst/":
      "/elastigroup/tutorials/elastigroup-tasks/create-encryption-key?id=step-1-login-to-your-aws-kms-console",

    "/getting-started-create-an-elastigroup-cluster-from-an-existing-elb/":
      "/elastigroup/tutorials/elastigroup-tasks/join-an-existing-elb?id=join-an-existing-elastic-load-balancer",

    "/elastigroup-for-aws/tutorials/restrict-your-spotinst-iam-policy/":
      "/elastigroup/tutorials/elastigroup-tasks/restrict-your-spot-iam-policy?id=restrict-your-spot-iam-policy",

    "/elastigroup-for-aws/tutorials/wordpress-on-spot-step-by-step-guide/":
      "/elastigroup/tutorials/elastigroup-tasks/wordpress-on-spot-step-by-step-guide?id=wordpress-on-spot-step-by-step-guide",

    "/managed-instances/tutorials/managed-instance-creation/":
      "/managed-instance/getting-started/?id=get-started-with-a-managed-instance",

    "/getting-started-spotinst-ocean-aws-gcp":
      "/ocean/getting-started/?id=getting-started",

    "/create-eks/":
      "/ocean/getting-started/eks/create-a-new-cluster?id=create-a-new-eks-cluster",

    "/ocean/ocean-overview-ecs/": "/ocean/overview-ecs?id=ocean-overview-ecs",

    "/ocean/ocean-overview-k8s/":
      "/ocean/overview-kubernetes?id=ocean-overview-kubernetes",

    "/ocean/tools-and-integrations/kops/get-started-with-kops/":
      "/ocean/tools-and-integrations/kops/?id=getting-started-with-kops",

    "/container-management/kubernetes/kops/clusters/":
      "/ocean/tools-and-integrations/kops/migrate-cluster?id=migrate-a-cluster",

    "/ocean/tools-and-integrations/openshift/openshift-v3-11/":
      "/ocean/tools-and-integrations/openshift/create-cluster-v311?id=create-ocean-cluster-from-openshift-v311",

    "/ocean/tutorials/migrate-elastigroups/":
      "/ocean/tutorials/migrate-existing-egs-ekskops?id=migrate-existing-elastigroups-to-ocean-eks-kops",

    "/ocean/tutorials/spotinst-kubernetes-controller/installing-kubernetes-controller-helm/":
      "/ocean/tutorials/spot-kubernetes-controller/install-with-helm?id=install-with-helm",
    ...
    "/container-management/kubernetes/kubernetes-tutorials/spotinst-kubernetes-controller/installing-kubernetes-controller/installing-kubernetes-controller-kubectl/":
      "/ocean/tutorials/spot-kubernetes-controller/install-with-kubectl?id=install-with-kubectl",
    ...
    "/ocean/tutorials/spotinst-kubernetes-controller/install-with-terraform/":
      "/ocean/tutorials/spot-kubernetes-controller/install-with-terraform?id=install-with-terraform",

    "/provisioning-ci-cd-sdk/provisioning-tools/ansible/":
      "/tools-and-provisioning/ansible?id=ansible-module-documentation",

    "/provisioning-ci-cd-sdk/provisioning-tools/cloudformation/troposphere/":
      "/tools-and-provisioning/cloudformation/tools/troposphere?id=troposphere",
    ...
    "/getting-started-create-an-elastigroup-cluster-from-an-existing-elb?id=join-an-existing-elastic-load-balancer":
      "/elastigroup/tutorials/elastigroup-tasks/join-an-existing-elb",
