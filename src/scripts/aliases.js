...
export const aliases = {
  "/account-user-management/user-management/access-policies-2": "/administration/access-policies/",
  ...
  "/container-management/docker-swarm": "/elastigroup/tools-integrations/docker-swarm/",

  "/container-management/kubernetes": "/ocean/getting-started/",

  "/container-management/kubernetes-2/eks": "/ocean/getting-started/eks/join-an-existing-cluster",

  "/container-management/kubernetes/gke": "/ocean/getting-started/gke",

  "/container-management/kubernetes/kops/1_14": "/ocean/tools-and-integrations/kops/",
  ...
  "/container-management/nomad/nomad-integration-with-elastigroup": "/elastigroup/tools-integrations/nomad/",

  "/container-management/openshift-2": "/ocean/tools-and-integrations/openshift/",

  "/container-management/rancher": "/elastigroup/tools-integrations/rancher/",

  "/eco/connect-your-aws-account": "/eco/getting-started/connect-your-aws-account",

  "/eco/eco-link-account": "/eco/getting-started/",

  "/elastigroup-for-aws/concepts/compute-concepts/shutdown-scripts": "/elastigroup/features/compute/shutdown-scripts",
  ...
  "/elastigroup-for-aws/concepts/scaling-concepts/target-scaling": "/elastigroup/features/scaling/target-scaling",

  "/elastigroup-for-aws/concepts/stateful-concepts": "/elastigroup/features/stateful-instance/",

  "/elastigroup-for-aws/services-integrations/aws-batch": "/elastigroup/tools-integrations/aws-batch",
  ...
  "/elastigroup-for-aws/services-integrations/codedeploy": "/elastigroup/tools-integrations/codedeploy/",

  "/elastigroup-for-aws/services-integrations/elastic-beanstalk": "/elastigroup/tools-integrations/elastic-beanstalk/",
  ...
  "/elastigroup-for-aws/services-integrations/elastic-mapreduce": "/elastigroup/tools-integrations/elastic-mapreduce/",

  "/elastigroup-for-aws/services-integrations/kafka": "/elastigroup/tools-integrations/kafka",

  "/elastigroup-for-aws/services-integrations/mesosphere": "/elastigroup/tools-integrations/mesosphere",

  "/elastigroup-for-aws/services-integrations/opsworks": "/elastigroup/tools-integrations/opsworks/",

  "/elastigroup-for-aws/services-integrations/rightscale": "/elastigroup/tools-integrations/rightscale",

  "/elastigroup-for-aws/services-integrations/route53": "/elastigroup/tools-integrations/route53",
  ...
  "/elastigroup-for-azure/hpc": "/elastigroup/tools-integrations/grid-engine-azure/",
  ...
  "/integration-docs/elastic-beanstalk/introduction": "/elastigroup/tools-integrations/elastic-beanstalk/",
  ...
  "/integration-docs/kubernetes/installing-kubernetes-controller": "/ocean/tutorials/spot-kubernetes-controller/",
  ...
  "/managed-instances/concepts/introduction": "managed-instance/getting-started/",

  "/ocean-aws/kubernetes/concepts/ocean-cloud/introduction": "/ocean/overview-kubernetes",

  "/ocean/kubernetes/concepts/ocean-cloud/introduction": "/ocean/overview-kubernetes",

  "/ocean/tutorials/ocean-for-aws/create-eks": "/ocean/getting-started/eks/create-a-new-cluster",

  "/ocean/tutorials/ocean-for-ecs": "/ocean/overview-ecs",

  "/ocean/tutorials/ocean-for-ecs/create-an-ocean-cloud-cluster": "/ocean/getting-started/ecs",
  ...
  "/provisioning-ci-cd-sdk/ci-cd/jenkins": "/tools-and-provisioning/ci-cd/jenkins",

  "/provisioning-ci-cd-sdk/provisioning-tools": "/tools-and-provisioning/",

  "/provisioning-ci-cd-sdk/provisioning-tools/cloudformation": "/tools-and-provisioning/cloudformation/",
  ...
  "/provisioning-ci-cd-sdk/provisioning-tools/terraform": "/tools-and-provisioning/terraform",
