...
- [Ocean](ocean/)
  ...
  - [Features & Concepts](ocean/features/)
    ...
    - [Virtual Node Groups](ocean/features/vngs/)
      - [Attributes & Actions per VNG](ocean/features/vngs/attributes-and-actions-per-vng)
      - [Preferred Spot Instance Types per VNG](ocean/features/vngs/preferred-spot-instance-types-per-vng)
